...
{
    private const float InitialVelocityMultiplier = 0.35f;

    private const float MinScaleMultiplier = 1.2f;
    private const float MaxScaleMultiplier = 1.8f;

    private const float RotationSpeed = 0.04f;
    private const float VelocityDamping = 0.98f;
    private const float ScaleDamping = 0.985f;

    private const float LightMultiplier = 0.55f;
    private const float LightGreenMultiplier = 0.9f;
