...
namespace Dairox_Mod.Content.Projectiles.Minions
{
    ...
    public class AncientSpirit : ModProjectile
    {
        ...
        public sealed override void SetDefaults()
        {
            ...
            Projectile.scale = 2f; // Visual scale of the projectile, will affect how its drawn
        }
        public override void ModifyDamageHitbox(ref Rectangle hitbox)
        {
            // Сдвигаем хитбокс вперёд по направлению движения миньон
            hitbox.X += 10;
            hitbox.Y += 10;

            // Можно также изменить размер хитбокса
            // hitbox.Inflate(10, 10); // увеличить на 10 пикселей в каждую сторону
        }
        ...
        private bool CheckActive(Player owner)
        {
            ...
            {
                owner.ClearBuff(ModContent.BuffType<AncientSpiritBuff>());

                return false;
            }

            if (owner.HasBuff(ModContent.BuffType<AncientSpiritBuff>()))
            {
